...
function startGame() {
  // we want to find scroll target
  const newleft = gameScreen.offsetLeft;

  console.log(newLeft);
  // we want to smoothly scroll towards next screen
  // https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollTo
  scrollTo({
    //scroll horizontally towards gamescreen's position
    left: newLeft; 
    //when we scroll, do so smoothly
    behavior: "smooth"
  })
